...
import type {
  PluginConfigSearchBarcode,
  PluginConfigSearchCategory,
  PluginConfigSearchHotPageLevelboard,
  PluginConfigSearchHotPageMainList,
  PluginConfigSearchHotPageTopButton,
  PluginConfigSearchTabbar,
  PluginShareInitiativeItem,
  PluginShareToken
} from '@/plugin/define'
...
export abstract class ContentPage<T extends object = any> {
  ...
  public static share = useGlobalVar(
    SourcedKeyMap.create<[plugin: string, key: string], PluginShareInitiativeItem>(),
    'uni/contentPage/share'
  )
  public static shareToken = useGlobalVar(
    SourcedKeyMap.create<[plugin: string, key: string], PluginShareToken>(),
    'uni/contentPage/shareToken'
  )

  public static tabbar = useGlobalVar(
    shallowReactive(new Map<string, PluginConfigSearchTabbar[]>()),
    'uni/contentPage/tabbar'
  )
  ...
  public static categories = useGlobalVar(
    shallowReactive(new Map<string, PluginConfigSearchCategory[]>()),
    'uni/contentPage/categories'
  )
  ...
  public static barcode = useGlobalVar(
    shallowReactive(new Map<string, PluginConfigSearchBarcode[]>()),
    'uni/contentPage/barcode'
  )
  ...
  public static levelboard = useGlobalVar(
    shallowReactive(new Map<string, PluginConfigSearchHotPageLevelboard[]>()),
    'uni/contentPage/levelboard'
  )
  ...
  public static topButton = useGlobalVar(
    shallowReactive(new Map<string, PluginConfigSearchHotPageTopButton[]>()),
    'uni/contentPage/topButton'
  )
  ...
  public static mainLists = useGlobalVar(
    shallowReactive(new Map<string, PluginConfigSearchHotPageMainList[]>()),
    'uni/contentPage/mainLists'
  )
